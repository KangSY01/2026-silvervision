...
| AbilityHistoryScreen (내 운동 기록) | - (중간보고서 4.1절, 2026-09-21 자가평가 방식으로 전면 교체) | 완료 (세션 목록 + 체감 난이도 표시) |
