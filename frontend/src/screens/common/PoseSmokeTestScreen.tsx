...
export default function PoseSmokeTestScreen() {
  ...
  // MediaPipe 플러그인 초기화는 JS 스레드를 동기로 막으므로 렌더 중이 아니라 마운트 뒤
  // effect에서 만든다(ExerciseProgressScreen과 같은 패턴, 인스턴스는 앱 전체 1회 재사용).
  ...
  if (!hasPermission || device == null || plugin == null) {
    return (
